...
reg [5:0] router_pointer;
reg [5:0] cpu_pointer;
reg [5:0] router_pointer_cpu;

reg [7:0] router_write_data;
reg [16:0] router_write_addr;
reg [16:0] router_write_addr_tmp;
...
xpm_cdc_array_single_inst_114514 (
  ...
  .src_in({internal_rx_ready, internal_rx_valid, internal_rx_last, internal_rx_data, router_write_state, 1'b0, router_write_addr})      // WIDTH-bit input: Input single-bit array to be synchronized to destination clock
...
(
  ...
  .addra(router_write_addr),  // input wire [16 : 0] addra
...
reg [5:0] cpu_pointer_2 = 0;
reg [5:0] cpu_pointer_2_router = 0;
reg [5:0] router_pointer_2 = 0;
...
(
  ...
  .addra(router_read_addr),  // input wire [16 : 0] addra
