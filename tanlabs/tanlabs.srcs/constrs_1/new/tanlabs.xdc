...
set_input_delay -clock clk_50M -max 20.000 [get_ports {base_ram_data[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports {base_ram_data[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports {base_ram_addr[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports {base_ram_be_n[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports base_ram_ce_n]
set_output_delay -clock clk_50M -max 20.000 [get_ports base_ram_oe_n]
set_output_delay -clock clk_50M -max 20.000 [get_ports base_ram_we_n]


set_input_delay -clock clk_50M -max 20.000 [get_ports {ext_ram_data[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports {ext_ram_data[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports {ext_ram_addr[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports {ext_ram_be_n[*]}]
set_output_delay -clock clk_50M -max 20.000 [get_ports ext_ram_ce_n]
set_output_delay -clock clk_50M -max 20.000 [get_ports ext_ram_oe_n]
set_output_delay -clock clk_50M -max 20.000 [get_ports ext_ram_we_n]

set_input_delay -clock clk_50M -max 20.000 [get_ports uart_tbre]
set_input_delay -clock clk_50M -max 20.000 [get_ports uart_tsre]
set_input_delay -clock clk_50M -max 20.000 [get_ports uart_dataready]
set_output_delay -clock clk_50M -max 20.000 [get_ports uart_rdn]
set_output_delay -clock clk_50M -max 20.000 [get_ports uart_wrn]
