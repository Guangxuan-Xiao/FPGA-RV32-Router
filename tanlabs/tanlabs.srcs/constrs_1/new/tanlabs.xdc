...
create_clock -period 20.000 -name core_clk -waveform {0.000 10.000} [get_nets core_clk]
...
set_input_delay -clock core_clk -max 20.000 [get_ports {base_ram_data[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports {base_ram_data[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports {base_ram_addr[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports {base_ram_be_n[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports base_ram_ce_n]
set_output_delay -clock core_clk -max 20.000 [get_ports base_ram_oe_n]
set_output_delay -clock core_clk -max 20.000 [get_ports base_ram_we_n]


set_input_delay -clock core_clk -max 20.000 [get_ports {ext_ram_data[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports {ext_ram_data[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports {ext_ram_addr[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports {ext_ram_be_n[*]}]
set_output_delay -clock core_clk -max 20.000 [get_ports ext_ram_ce_n]
set_output_delay -clock core_clk -max 20.000 [get_ports ext_ram_oe_n]
set_output_delay -clock core_clk -max 20.000 [get_ports ext_ram_we_n]

set_input_delay -clock core_clk -max 20.000 [get_ports uart_tbre]
set_input_delay -clock core_clk -max 20.000 [get_ports uart_tsre]
set_input_delay -clock core_clk -max 20.000 [get_ports uart_dataready]
set_output_delay -clock core_clk -max 20.000 [get_ports uart_rdn]
set_output_delay -clock core_clk -max 20.000 [get_ports uart_wrn]
